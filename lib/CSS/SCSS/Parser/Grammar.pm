...
our @EXPORT = qw(css_grammar css_rules);
...
sub css_rules {
    return [
        ...
        { lhs => 'selectors', rhs => [qw(selector optional_space COMMA optional_space selectors)] },
        ...
        { lhs => 'divider', rhs => [qw(SPACE)], action => 'divider_space' },
        { lhs => 'divider', rhs => [qw(GT)],    action => 'divider_gt' },
        { lhs => 'divider', rhs => [qw(PLUS)],  action => 'divider_plus' },
        ...
        { lhs => 'expression', rhs => [qw(expr expression)] },

        # { lhs => 'expr_op', rhs => [qw(SPACE)], action => 'divider_space' },
        { lhs => 'expr_op', rhs => [qw(optional_space COMMA optional_space)], action => 'divider_comma' },
        { lhs => 'expr_op', rhs => [qw(optional_space SLASH optional_space)], action => 'divider_slash' },   ### FIXME: conflict with "/" factor_op
